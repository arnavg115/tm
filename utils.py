...
def get_embeddings(
    ...
    API_URL = (
        "https://api-inference.huggingface.co/pipeline/feature-extraction/{}".format(
            model
        )
    )
...
def find_describer_bert(
    text_embedding: np.ndarray, vocab: List[str], hf_key: str, n: int = 5
):
